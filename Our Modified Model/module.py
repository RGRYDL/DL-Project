...
def discriminator(image, options, reuse=False, name="discriminator"):
    ...
    with tf.variable_scope(name):
        ...
        #h4 = sigmoid(conv2d(h3, 1, s=1, name='d_h3_pred'))
        # h4 is (32 x 32 x 1)
        return h4

def generator(image, options, output_c, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name):
        ...
        e8 = conv2d(lrelu(e7), options.gf_dim*8, name='g_e8_conv')
        ...
        d8 = deconv2d(tf.nn.relu(d7), output_c, name='g_d8')
